  ...
  render(){
    return(
      <Fragment>
        ...
        <Table className="task-table" columns={columns} dataSource = {this.props.taskData.bigTasks == null ? null : this.props.taskData.bigTasks[0].smallTasks }  pagination={setting}         
           onRow={(record,rowkey)=>{
             return{
