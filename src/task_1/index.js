              ...
              <Form.Item label="任务状态">
                {getFieldDecorator('station', {
                  ...
                  >
                    ...
                    {
                      personal.identity.contains("组长") || personal.identity.contains("设计负责人") == true ?<Option key = "3" value="已完成" >已完成</Option>:null
                    }
  ...
  render(){
    return(
      <Fragment>
        ...
        <Table rowKey="id" className="task-table" columns={columns} dataSource = {this.props.taskData.getIn(['bigTasks']) == null ? null : this.props.taskData.getIn(['bigTasks',1,'smallTasks']).toJS() }  pagination={setting}         
           onRow={(record,rowkey)=>{
             return{
